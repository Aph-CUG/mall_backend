...
public class OrderServiceImpl implements OrderService {
    ...
    public String create(CreateOrderReq createOrderReq){
        ...
        // 生成订单号，有独立规则
        String orderNu = OrderCodeFactory.getOrderCode(Long.valueOf(userId));
        order.setOrderNo(orderNu);
    ...
    public String qrcode(String orderNo){
        ...
        try {
            QRCodeGenerator.
                    generateQRCodeImage(payUrl,350,350,Constant.File_UPLOAD_DIR+orderNo+".png");
